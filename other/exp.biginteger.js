/**
 * Wrapper for Leemon's BigInt.js 
 * following http://docs.oracle.com/javase/1.3/docs/api/java/math/BigInteger.html
 *
 * @author Khandar William
 * @recommended seedrandom.js
 */

Exp = {}; // short for EXPeriment
Exp.BigInteger = (function () {
	// random seed
	Math.seedrandom();
	...
	/**
	 * Create new BigInteger object
	 */
	function BigInteger(param1, param2, param3) {
		// BigInteger('bare', bigInt val)
		// FOR INTERNAL USE ONLY: receives a BigInt.js value and set it
		if (param1 === 'bare' && typeof param2 === 'object' && typeof param3 === 'undefined') {
			this._ = param2;
		} else
		// BigInteger(byte[] val) 
		// Translates a byte array containing the two's-complement binary representation of a BigInteger into a BigInteger.
		if (isArray(param1) && typeof param2 === "undefined" && typeof param3 === "undefined") {

		} else 
		// BigInteger(int signum, byte[] magnitude) 
		// Translates the sign-magnitude representation of a BigInteger into a BigInteger.
		if (typeof param1 === "number" && isArray(param2) && typeof param3 === "undefined") {

		} else
		// BigInteger(int bitLength, int certainty, Random rnd) 
		// Constructs a randomly generated positive BigInteger that is probably prime, with the specified bitLength.
		if (typeof param1 === "number" && typeof param2 === "number" && typeof param3 === "object") {

		} else 
		// BigInteger(int numBits, Random rnd) 
		// Constructs a randomly generated BigInteger, uniformly distributed over the range 0 to (2^numBits - 1), inclusive.
		if (typeof param1 === "number" && typeof param2 === "object" && typeof param3 === "undefined") {

		} else
		// BigInteger(String val) 
		// Translates the decimal String representation of a BigInteger into a BigInteger.
		if (typeof param1 === "string" && typeof param2 === "undefined" && typeof param3 === "undefined") {
			this._ = str2bigInt(param1, 10);
		} else 
		// BigInteger(String val, int radix) 
		// Translates the String representation of a BigInteger in the specified radix into a BigInteger.
		if (typeof param1 === "string" && typeof param2 === "number" && typeof param3 === "undefined") {
	...
	// Wraps a BigInt value as an instance of this class
	BigInteger.create = function (val) {
		return new BigInteger('bare', val);
	};
