 ...
 *
 * 2012-07-11 copy from amiller source
 */

Otr.DSAKey = (function () {

var BigInteger = Otr.BigInteger,
    SecureRandom = Otr.SecureRandom;
...
// @param {Number} B Bit key length
// @param {Function} H Hash function (String hex) return Array of byte
...
var TWO = new BigInteger('2'),
	TWOpow159 = TWO.pow(159),
	TWOpow160 = TWO.pow(160);
...
function generateQ(rng, H) {
    ...
    if (TWOpow159.compareTo(q) < 0 && TWOpow160.compareTo(q) > 0)
        return [S, q];
