...
// Util.powMod(biX, biY, biN)
// Because JSBN modPow is too slow on Firefox
// @param {BigInteger} biX, biY, biN
// @return biX ^ biY mod biN
// !WARNING! assumed biX.bitLength() <= biN.bitLength()
(function () {
////////////////////////////////////////////////////////////////////////////////////////
...
Otr.Util.powMod = function (biX, biY, biN) {
	biX = str2bigInt(biX.toString(16), 16);
	biY = str2bigInt(biY.toString(16), 16);
	biN = str2bigInt(biN.toString(16), 16);
	return new Otr.BigInteger(bigInt2str(powMod(biX, biY, biN), 16), 16);
};
